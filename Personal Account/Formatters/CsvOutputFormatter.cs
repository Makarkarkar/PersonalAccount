...
namespace AspNetCoreCsvImportExport.Formatters
{
    ...
    public class CsvOutputFormatter : OutputFormatter
    {
        ...
        public async override Task WriteResponseBodyAsync(OutputFormatterWriteContext context)
        {
            ...
            await streamWriter.WriteLineAsync("Идентификатор пассажира," +
                                                  "Дата и время проведения регистрируемой операции," +
                                                  "Пункт проведения регистрируемой операции с перевозочным документом," +
                                                  "Отправитель," +
                                                  "Время транзакции," +
                                                  "Временная зона операции," +
                                                  ...
                                                  "Идентификатор документа пассажира," +
                                                  "Тип документа пассажира," +
                                                  "Номер документа пассажира," +
                                                  "Подтверждающего статус инвалидности номер документа," +
                                                  "Подтверждающего статус члена многодетной семьи номер документа," +
                                                  "Идентификатор типа субсидируеиого пассажира," +
                                                  "Тип субсидируемого пассажира," +
                                                  "Тип субсидироемого пассажира(en)," +
                                                  "Сокращенный тип субсидируемого пассажира," +
                                                  "Описание пассажира," +
                                                  "Наличие квоты," +
                                                  "Идентификатор перевозочного документа," +
                                                  "Номер билета," +
                                                  "Тип перевозочного документа," +
                                                  "Идентификатор маршрута," +
                                                  "Код авиакомпании," +
                                                  "Аэропорт отправления по регулярному (сезонному) расписанию," +
                                                  "Дата и время отправления рейса по регулярному (сезонному) расписанию," +
                                                  "Аэропорт назначения по регулярному (сезонному) расписанию," +
                                                  "Дата и время посадки по регулярному (сезонному) расписанию," +
                                                  "Номер бронирования (указатель PNR)," +
                                                  "Код операционного перевозчика," +
                                                  "Временная зона даты отправления," +
                                                  "Временная зона даты назнаяения," +
                                                  "Код города отправления," +
                                                  "Город отправления," +
                                                  "Код аэропорта отправления(ICAO)," +
                                                  "Код аэропорта отправления(РФ)," +
                                                  "Аэропорт отправления," +
                                                  "Код города назначения," +
                                                  "Город отправления," +
                                                  "Код аэропорта направления(ICAO)," +
                                                  "Код аэропорта направления(РФ)," +
                                                  "Аэропорт направления," +
                                                  "Номера рейсов в билете," +
                                                  "Код тарифа," +
                                                  "Цена тарифа");
